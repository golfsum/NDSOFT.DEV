...
export const metadata: Metadata = {
  ...
  description:
    'Privacy policy for ND Software LLC and its apps, including Uncrop It.',
};
  ...
  return (
    <article className="mx-auto max-w-3xl px-6 py-16 prose-legal">
      ...
      <p>
        ...
        Uncrop It and other applications for Apple platforms (each, an
      ...
      <p>
        ...
        operating-system details, and request metadata — to operate, secure,
      ...
      <h3>3.3 Apple</h3>
      <p>
        Our apps run on Apple platforms. When you download an app or make a
      ...
      <p>
        ...
        our apps or website from outside the United States, you understand that
        your information may be processed in jurisdictions with different
      ...
      <p>
        ...
        changes will be reflected prominently on this page. Continued use of our
        apps or website after the updated policy takes effect means you accept
        the updated policy.
      </p>
