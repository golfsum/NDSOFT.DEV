...
export const metadata: Metadata = {
  ...
  description:
    'Terms of Service for ND Software LLC and its apps, including Uncrop It.',
};
  ...
  return (
    <article className="mx-auto max-w-3xl px-6 py-16 prose-legal">
      ...
      <p>
        ...
        applications, including Uncrop It (each, an &ldquo;App&rdquo; and
      ...
      <p>
        Some features of our Apps require a paid plan or purchase. Where an App
        offers paid options, these may include auto-renewing{' '}
      ...
      <p>
        Our Apps operate on content you provide &mdash; for example, the photos
        you choose to uncrop, resize, or animate in Uncrop It. To deliver these
        features, that content is uploaded to our backend and sent to our AI
        processing providers to generate a result, as described in our{' '}
        <a href="/privacy">Privacy Policy</a>. You retain ownership of the
        content you provide, and you grant us the limited rights necessary to
        host and process it solely to deliver the Services to you.
      </p>
      <p>
