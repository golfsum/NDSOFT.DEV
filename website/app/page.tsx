    ...
    <div className="mx-auto max-w-5xl px-6">
      <section className="pt-24 pb-16">
        <h1 className="text-5xl sm:text-6xl font-bold tracking-tight max-w-3xl">
          Small, focused tools for <span className="text-[var(--color-brand)]">Apple platform</span> developers.
        </h1>
        <p className="mt-8 text-lg text-[var(--color-text-dim)] max-w-2xl leading-relaxed">
          ND Software builds utilities that do one thing well — no accounts, no
          telemetry, no bloat. Bring your own keys, keep your own data.
        </p>
      </section>
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <h3 className="mt-2 text-2xl font-bold">BuildPad</h3>
                <p className="mt-3 text-sm text-[var(--color-text-dim)] leading-relaxed">
                  Every TestFlight build across every app on your App Store
                  Connect account — sorted by which one expires soonest.
                </p>
              </div>
            </div>
      ...
      <section className="pb-24">
        ...
        <p className="text-[var(--color-text-dim)] max-w-2xl leading-relaxed">
          ND Software LLC is an independent developer studio based in Arizona.
